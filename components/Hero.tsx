  ...
  return (
    <div className="relative h-screen w-full overflow-hidden flex items-center justify-center">
      <div className="absolute inset-0 z-0">
        {content?.home?.hero?.backgroundVideo ? (
          <video
            ...
            poster={content?.home?.hero?.backgroundImage}
          >
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        <h2 className="text-sm md:text-base font-bold uppercase tracking-[0.3em] text-zinc-300 mb-6">
        ...
        <h1 className="text-5xl md:text-8xl font-black uppercase tracking-tighter leading-none mb-8 text-white">
          A igreja <br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-zinc-400">que nunca dorme</span>
        </h1>
